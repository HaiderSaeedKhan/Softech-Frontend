...
export class UploadComponent implements OnInit {
  ...
  progress: number = 0; // ✅ Local progress value fed by service
  ...
  ngOnInit(): void {
    ...
    this.videoService.uploadProgress$.subscribe(p => {
      this.progress = p;
    });
